...
type Student struct {
	...
	StudentID    string  `gorm:"column:student_id;uniqueIndex;not null;size:20" json:"student_id"` // References User.StudentID
	...
	// Relationships
	User       User        `gorm:"foreignKey:StudentID;references:StudentID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE" json:"user,omitempty"`
